...
obfs_class * new_obfs_class(char *plugin_name)
{
    ...
    /*} else if (strcmp(plugin_name, "verify_simple") == 0) {
        ...
        plugin->client_pre_encrypt = auth_chain_b_client_pre_encrypt;
        plugin->client_post_decrypt = auth_chain_b_client_post_decrypt;
        plugin->client_udp_pre_encrypt = auth_chain_b_client_udp_pre_encrypt;
        plugin->client_udp_post_decrypt = auth_chain_b_client_udp_post_decrypt;
